...
# Assert
TARGET_OTA_ASSERT_DEVICE := A37

# Partitions
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 26875904 # This is the maximum known partition size, but it can be higher, so we just omit it
